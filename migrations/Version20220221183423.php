 ...
 */
final class Version20220221183423 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE almacen (id INT AUTO_INCREMENT NOT NULL, empresa_id INT NOT NULL, propietario_id INT DEFAULT NULL, config_id INT DEFAULT NULL, tipo_almacen VARCHAR(50) NOT NULL, nombre VARCHAR(50) NOT NULL, direccion VARCHAR(50) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, activo TINYINT(1) NOT NULL, uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', UNIQUE INDEX UNIQ_D5B2D250D17F50A6 (uuid), INDEX IDX_D5B2D250521E1991 (empresa_id), INDEX IDX_D5B2D25053C8D32C (propietario_id), INDEX IDX_D5B2D25024DB0683 (config_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE empresa DROP FOREIGN KEY FK_B8D75A5024DB0683');
        $this->addSql('ALTER TABLE lote DROP FOREIGN KEY FK_65B4329F24DB0683');
        ...
        $this->addSql('ALTER TABLE empresa DROP FOREIGN KEY FK_B8D75A5053C8D32C');
        $this->addSql('ALTER TABLE lote DROP FOREIGN KEY FK_65B4329F53C8D32C');
